...
bool AnimationModel::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
...
bool AnimationModel::insertColumns(int column, int count, const QModelIndex &parent)
{
...
bool AnimationModel::removeColumns(int column, int count, const QModelIndex &parent)
{
